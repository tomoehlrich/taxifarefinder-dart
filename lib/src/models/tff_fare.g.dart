...
TffFare _$TffFareFromJson(Map<String, dynamic> json) {
  return TffFare(
      ...
      flatRates: (json['flat_rates'] as List)
          ?.map((e) => e == null
              ? null
              : TffFlatRate.fromJson(e as Map<String, dynamic>))
          ?.toList(),
...
TffFlatRate _$TffFlatRateFromJson(Map<String, dynamic> json) {
  return TffFlatRate(
      charge: json['charge'] == null
          ? null
          : TffFlatRate._stringToDouble(json['charge'] as String),
...
TffExtraCharge _$TffExtraChargeFromJson(Map<String, dynamic> json) {
  return TffExtraCharge(
      charge: json['charge'] == null
          ? null
          : TffExtraCharge._stringToDouble(json['charge'] as String),
      description: json['description'] as String);
}

_TffCurrency _$_TffCurrencyFromJson(Map<String, dynamic> json) {
  return _TffCurrency(intSymbol: json['int_symbol'] as String);
}
